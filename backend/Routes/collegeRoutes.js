...
/* =====================================================
   👑 ADMIN ROUTES (COLLEGE MANAGEMENT)
===================================================== */
collegeRouter.post(
  "/register",
  roleMiddleware("admin"),
...
/* =====================================================
   🏫 COLLEGE ROUTES (DASHBOARD & OPERATIONS)
===================================================== */

// 🔹 Exam sessions (USED IN ViewUploadedSheets.jsx)
collegeRouter.get(
  "/exam-sessions/all",
  roleMiddleware("college"),
  getAllExamSessions
...
// 🔹 Students by college (USED IN ViewUploadedSheets.jsx)
collegeRouter.get(
